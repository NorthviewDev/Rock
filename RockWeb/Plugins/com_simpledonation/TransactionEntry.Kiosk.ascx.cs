...
namespace Plugins.com_simpledonation
{
    ...
    [BooleanField( "Cover Fees Checked", "Determines whether the 'cover fees' checkbox is checked by default", false, "", 13 )]
    #endregion
    ...
    public partial class TransactionEntryKiosk : Rock.Web.UI.RockBlock
    {
        ...
        private void ProcessSwipe( string swipeData )
        {
            try
            {
                using ( RockContext rockContext = new RockContext() )
                {
                    ...
                    {
                        FeeCalculationResult feeResult = _feeCalculationService.CalculateFees( Amounts, feeAmount );
        ...
        private void RegisterAccountInfo()
        {
