...
",
        ...
        private IQueryable<IEntity> GetQueryableData()
        {
            ...
            var entityType = Rock.Web.Cache.EntityTypeCache.Read( etEntityType.SelectedEntityTypeId.Value );
        ...
        protected void etEntityType_SelectedIndexChanged( object sender, EventArgs e )
        {
            ...
            {
                var entityType = Rock.Web.Cache.EntityTypeCache.Read( entityTypeId.Value );
                if ( entityType != null )
                {
                    var type = Type.GetType( entityType.AssemblyName );
