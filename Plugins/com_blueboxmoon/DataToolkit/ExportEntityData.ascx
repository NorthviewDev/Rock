            ...
            <div class="panel-body">
                <asp:Panel ID="pnlDetails" runat="server" style="position: relative;">
                    ...
                    <asp:Panel ID="pnlExportOptions" runat="server" Visible="false">
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <Rock:DataViewPicker ID="dvFilter" runat="server" Label="DataView Filter" Help="If you want to filter the data that is exported you may select a DataView to filter those results." />
                            </div>
