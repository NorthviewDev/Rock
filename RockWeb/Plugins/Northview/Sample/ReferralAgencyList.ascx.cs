...
using us.northview.Model.Referral;
...
[Category("us_northviewchurch > Sample Project")]
...
public partial class ReferralAgencyList : Rock.Web.UI.RockBlock
{
    ...
    private void BindFilter()
    {
        ...
        var definedType = DefinedTypeCache.Read(us.northview.SystemGuid.DefinedType.REFERRAL_AGENCY_TYPE.AsGuid());
        if (definedType != null)
        {
